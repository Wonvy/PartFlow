          ...
          {locations.map((location) => (
            <div
              ...
              style={{
                position: "relative",
                background: colors.surface,
                border: `2px solid ${selectedLocation === location.id ? colors.accent : colors.gray200}`,
                borderRadius: borderRadius.lg,
                padding: spacing.xl,
                cursor: "pointer",
                transition: transitions.base,
            ...
            >
              ...
              {hoveredCard === location.id && (
                <button
                  onClick={(e) => handleDelete(location.id, location.name, e)}
                  style={{
                    position: "absolute",
                    top: spacing.md,
                    right: spacing.md,
              ...
              <div style={{
                ...
                <span style={{
                  ...
                  {selectedLocation === location.id ? `${locationParts.length} 个零件` : "点击查看零件"}
                </span>
              </div>
              ...
              {/* 展开的零件列表 */}
              {selectedLocation === location.id && locationParts.length > 0 && (
                <div style={{
